...
public class Productdetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pt=(TextView)findViewById(R.id.ptype);
        price=(TextView)findViewById(R.id.price);
        bn=(TextView)findViewById(R.id.bar);
        md=(TextView)findViewById(R.id.ManDate);
        ed=(TextView)findViewById(R.id.edate);
        sn=(TextView)findViewById(R.id.shelfno);
        an=(TextView)findViewById(R.id.aisle);
        ...
        try {
            ...
            try {
               ...
               //SD1 = new StoreBarDetails(job2.getString("ProductName"),job2.getString("ProductType"),Integer.parseInt(job2.getString("Price")),job2.getString("BarcodeNumber"),job2.getString("ManufacturingDate"),job2.getString("ExpiryDate"),Integer.parseInt(job2.getString("ShelfNumber")),Integer.parseInt(job2.getString("AisleNumber")),Integer.parseInt(job2.getString("ProductId")),job2.getString("Description"));
                ...
                price.setText(job2.getString("Price"));
                bn.setText(job2.getString("BarcodeNumber"));
                md.setText(job2.getString("ManufacturingDate"));
                ed.setText(job2.getString("ExpiryDate"));
                sn.setText(job2.getString("ShelfNumber"));
                an.setText(job2.getString("AisleNumber"));
                pid.setText(job2.getString("ProductId"));
                des.setText(job2.getString("Description"));
                s="Product Name is "+job2.getString("ProductName")+" Product Type is "+ job2.getString("ProductType")+" Price is rupees " + job2.getString("Price") + " Expiry date is "+ job2.getString("ExpiryDate")+" Shelf number is "+ job2.getString("ShelfNumber")+" Description of the product is "+job2.getString("Description");
                Log.e("Strin S is ",s);
    ...
    private void listen(){
        ...
        try {
            ...
            Toast.makeText(Productdetails.this, "Your device doesn't support Speech Recognition", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
        ...
        if(requestCode == 100){
            if (resultCode == RESULT_OK && null != data) {
               ...
               int d=Integer.parseInt(result.get(0));
                ...
                {
                    Intent n=new Intent(Productdetails.this,Internetservice.class);
                    stopService(n);
                    finish();
                    moveTaskToBack(true);
                    return;
